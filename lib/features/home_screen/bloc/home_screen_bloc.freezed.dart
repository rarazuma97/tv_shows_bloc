...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({TvShowResponse items});

  $TvShowResponseCopyWith<$Res> get items;
}
...
class __$$LoadedImplCopyWithImpl<$Res>
  ...
  @pragma('vm:prefer-inline')
  $TvShowResponseCopyWith<$Res> get items {
    return $TvShowResponseCopyWith<$Res>(_value.items, (value) {
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(this.items);

  @override
  final TvShowResponse items;

  @override
  String toString() {
    return 'HomeScreenState.loaded(items: $items)';
  }
...
abstract class _Loaded implements HomeScreenState {
  const factory _Loaded(final TvShowResponse items) = _$LoadedImpl;

  TvShowResponse get items;
  @JsonKey(ignore: true)
  _$$LoadedImplCopyWith<_$LoadedImpl> get copyWith =>
      throw _privateConstructorUsedError;
}
